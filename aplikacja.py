...
if k == 'biznes klasa':
    podstawa = 300
    if w_dodatkowa > 32:
        print(' Twój bagaż dodatkowy przekracza dopuszcalną wagę (max 32 kg)! Proszę zmniejszyć wagę bagażu! ')
    if w_dodatkowa <= 32:
        print(' Waga bagażu dodatkowego jest dopuszczalna ! ')
    if w_podreczna <= 8:
...
if k == 'klasa ekonomiczna':
    podstawa = 100
    if w_dodatkowa > 23:
        print(' Twój bagaż dodatkowy przekracza dopuszcalną wagę (max 23 kg)! Prosze zmniejszyć wagę bagażu! ')
    if w_dodatkowa <= 23:
        print('Waga bagażu dodatkowego jest dopuszczalna !')
    if w_podreczna <= 8:
        cena_biletu = cena_na_osobe + podstawa
